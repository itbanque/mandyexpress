export const en = {
  ...
  meta: {
    ...
    about: {
      title: "About Us",
      description:
        "Mandy Express is a Canadian-owned freight carrier specialized in the Montreal–Toronto Highway 401 corridor, committed to on-time delivery and personal service."
    },
    contact: {
      title: "Contact Us",
      description:
  ...
  aboutPage: {
    ...
    heroImageAlt: "Mandy Express Sprinter cargo van on the Highway 401 Toronto corridor",
    eyebrow: "About Mandy Express",
    heroTitleLines: ["More Than Cargo.", "Your Trust, Our Priority."],
    heroParagraphs: [
    ...
    storyParagraphs: [
      "Mandy Express was founded with a simple mission: to provide fast, reliable, and hassle-free freight service between Montreal and Toronto.",
      "With years of experience in the logistics industry, we understand what businesses need - consistent service, clear communication, and a partner you can count on.",
      "We don't just move cargo. We deliver peace of mind."
    ],
